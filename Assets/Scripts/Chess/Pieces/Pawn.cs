...
namespace Chess
{
    public class Pawn : ChessPiece
    {
        public override List<Vector2Int> GetAvailableMoves(ChessPiece[,] board, int boardSize)
        {
            ...
            {
                if (board[currentPosition.x, currentPosition.y + direction] == null)
                {
                    ...
                    if ((team == PieceTeam.White && currentPosition.y == 1) || (team == PieceTeam.Black && currentPosition.y == 6))
                    {
                        ...
                        {
                            if (board[currentPosition.x, currentPosition.y + direction * 2] == null)
                            {
            ...
            {
                if (IsWithinBounds(currentPosition.x + offset, currentPosition.y + direction, boardSize))
                {
